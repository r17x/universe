---
name: gateway-nix
description: Nix Gateway
updated: "2026-05-10"
---

Routes Nix tasks to the nix-coder worker agent and loads domain-specific skill-library files based on the Nix subsystem involved.
...
3. **Route to appropriate agent**:
   - All `.nix` files → delegate to the domain worker defined in `.anakmagang/config.yaml` ground.routing
