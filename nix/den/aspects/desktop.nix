...
in
{
  den.aspects.desktop = {
    ...
    tests =
      { eR17, ... }:
      {
        test-aerospace-reserves-space-for-bar = {
          expr = eR17.services.aerospace.settings.gaps.outer;
          expected = {
            top = 50;
            bottom = 15;
            left = 15;
        ...
        test-sketchybar-runs-at-background-priority = {
          expr = {
            inherit (eR17.launchd.user.agents.sketchybar.serviceConfig) Nice LowPriorityIO ProcessType;
          };
          expected = {
            Nice = 5;
            LowPriorityIO = true;
        ...
        test-jankyborders-renders-rounded-borders = {
          expr = {
            inherit (eR17.services.jankyborders) enable width style;
          };
          expected = {
            enable = true;
            width = 6.5;
